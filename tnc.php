...
<head>
  ...
  <title>Bio MP |  Terms of service</title>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li data-translation-key="foo2">Terms Of Services</li>
        </ol>
        <h2 data-translation-key="foo2">Terms Of Services</h2>

      </div>
    </section><!-- End Breadcrumbs -->

<!-- Add this section after the existing content in your HTML file -->

  <section class="terms-and-conditions">
    <div class="container">

      <h5 data-translation-key="tnc1">PLEASE READ THESE BIO MP PLATFORM TERMS OF USE AND BIO MP MINING TERMS OF SERVICE (“Terms”) CAREFULLY BEFORE USING THE THE PLATFORM OR SERVICES DESCRIBED HEREIN. BY SELECTING “I AGREE”, ACCESSING THE PLATFORM, USING BIO MP MINING SERVICES OR USING BIO MP MINING SOFTWARE, YOU ARE ACKNOWLEDGING THAT YOU HAVE READ THESE TERMS, AS AMENDED FROM TIME TO TIME, AND YOU ARE AGREEING TO BE BOUND BY THEM. IF YOU DO NOT AGREE TO THESE TERMS, OR ANY SUBSEQUENT AMENDMENTS, CHANGES OR UPDATES, DO NOT ACCESS THE PLATFORM, USE BIO MP MINING SERVICES OR USE THE BIO MP MINING SOFTWARE.</h5>


      <ol>
        <li>
          <p data-translation-key="tnc2"></p>
        </li>
        <li>
          <p data-translation-key="tnc3"></p>
        </li>
        <li>
          <p data-translation-key="tnc4"></p>
        </li>
        <li>  
          <p data-translation-key="tnc5"></p>
        </li>
        <li>
          <p data-translation-key="tnc6"></p>        
        </li>
        <li>
          <p data-translation-key="tnc7"></p>
        </li>
        <li>
          <p data-translation-key="tnc8"></p>        
        </li>
        <li>
          <p data-translation-key="tnc9"></p>        
        </li>
        <li>
          <p data-translation-key="tnc10"></p>            
        </li>
        <li>
          <p data-translation-key="tnc11"></p>    
        </li>
        <li>
          <p data-translation-key="tnc12"></p>    
        </li>
        <li>
          <p data-translation-key="tnc13"></p>            
        </li>
        <li>
          <p data-translation-key="tnc14"></p>            
        </li>
        <li>
          <p data-translation-key="tnc15"></p>            
        </li>
        <li>
          <p data-translation-key="tnc16"></p>            
        </li>
        <li>
          <p data-translation-key="tnc17"></p>            
        </li>
      </ol>
    </div>
  </section>
