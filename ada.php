                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>Cardano Information</h3>
                            <ul>
                                <li><strong>Last Price</strong>: $0.721</li>
                                <li><strong>24 Hours Change</strong>: -6.43%</li>
                                <li><strong>Market Cap</strong>: $24.78B</li>
                                <li><strong>Supply</strong>: 30M</li><br>
                            </ul>
                        </div>
                        <br>
                        <div class="portfolio-info">
