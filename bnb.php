                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>BNB Information</h3>
                            <ul>
                                <li><strong>Last Price</strong>: $404.95</li>
                                <li><strong>24 Hours Change</strong>: -4.45%</li>
                                <li><strong>Market Cap</strong>: $67.01B</li>
                                <li><strong>Supply</strong>: 23.1M</li><br>
                            </ul>
                        </div>
                        <br>
                        <div class="portfolio-info">
